...
public class CloneablePowersPatch {
    ...
    public static class RetainCardPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + RetainCardPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class RitualPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
    ...
    public static class RupturePowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + RupturePower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SadisticPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SadisticPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SharpHidePowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SharpHidePower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class ShiftingPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + ShiftingPower.class.getName() + "(owner);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SkillBurnPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SkillBurnPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SlowPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SlowPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SplitPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SplitPower.class.getName() + "(owner);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SporeCloudPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SporeCloudPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class StasisPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + StasisPower.class.getName() + "(owner, card);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class StormPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + StormPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class StrengthPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + StrengthPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class SurroundedPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + SurroundedPower.class.getName() + "(owner);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class TheBombPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + TheBombPower.class.getName() + "(owner, amount, damage);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class ThieveryPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + ThieveryPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class ThornsPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + ThornsPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class ThousandCutsPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + ThousandCutsPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class TimeMazePowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + TimeMazePower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class TimeWarpPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + TimeWarpPower.class.getName() + "(owner);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class ToolsOfTheTradePowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + ToolsOfTheTradePower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class UnawakenedPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + UnawakenedPower.class.getName() + "(owner);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class VulnerablePowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + VulnerablePower.class.getName() + "(owner, amount, justApplied);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class WeakPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + WeakPower.class.getName() + "(owner, amount, justApplied);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
    ...
    public static class WinterPowerPatch {
        public static void Raw(CtBehavior ctMethodToPatch) throws NotFoundException, CannotCompileException {
            CtClass ctClass = ctMethodToPatch.getDeclaringClass();
            ClassPool pool = ctClass.getClassPool();
            ...
            CtMethod method = CtNewMethod.make(
                    ...
                    new CtClass[]{},
                    null, // Exceptions
                    "return new " + WinterPower.class.getName() + "(owner, amount);",
                    ctClass
            );
            ctClass.addMethod(method);
        }
